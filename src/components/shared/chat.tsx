    ...
    <div className="flex flex-col h-full overflow-hidden">
     <Header />
      <div className="flex h-full">
         {/* First cols */}
         <div className="max-w-[70px] w-full flex flex-col p-2 items-center bg-[#F9FBFC] border rounded-l-md h-full">
            ...
            <div className="gap-6 flex flex-col justify-between py-8 mt-5 items-center m-1 h-full">
         ...
         {/*Third cols */}
         <div className="w-full border flex flex-col rounded-r-md overflow-hidde">
            ...
            <div className="p-10 h-20 border flex items-center rounded-tr-md">
             ...
             <div className="px-10 pt-5 pb-10 flex-1 overflow-y-auto scroll-smooth
                  scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
               <div className="h-ful flex flex-col gap-5">
             ...
             <div className="h-20 flex  rounded-r-md sticky bottom-0 bg-white w-[98%]">
